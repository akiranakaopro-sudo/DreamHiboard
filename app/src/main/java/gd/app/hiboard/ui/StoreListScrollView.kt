 ...
 * Pulling past the top or bottom springs back.
 */
class StoreListScrollView @JvmOverloads constructor(
    ...
    private companion object {
        ...
        val OVERSCROLL = object : FloatPropertyCompat<StoreListScrollView>("overscroll") {
            override fun getValue(view: StoreListScrollView): Float = view.overscroll

            override fun setValue(view: StoreListScrollView, value: Float) {
